...
var _user$project$Main$stringReplace = F4(
	function (insert, start, end, string) {
		var chars = _elm_community$string_extra$String_Extra$toCodePoints(string);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_community$string_extra$String_Extra$fromCodePoints(
				A2(_elm_lang$core$List$take, start, chars)),
			A2(
				_elm_lang$core$Basics_ops['++'],
				insert,
				_elm_community$string_extra$String_Extra$fromCodePoints(
					A2(_elm_lang$core$List$drop, end, chars))));
	});
var _user$project$Main$charsLength = function (string) {
	return _elm_lang$core$List$length(
		_elm_community$string_extra$String_Extra$toCodePoints(string));
};
var _user$project$Main$moveCaretRight = F2(
	function (pos, max) {
		return A2(_elm_lang$core$Basics$min, max, pos + 1);
	});
var _user$project$Main$moveCaretLeft = function (pos) {
	return A2(_elm_lang$core$Basics$max, 0, pos - 1);
};
var _user$project$Main$model = {id: 'editor', isFocused: false, content: '', lastKey: '', caretColumn: 0, caretRow: 0, isSelected: false, rangeFrom: 0};
var _user$project$Main$onChange = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'change',
		eventOptions,
		A2(_elm_lang$core$Json_Decode$map, handler, _rtfeldman$elm_css$Html_Styled_Events$targetValue));
};
var _user$project$Main$onInput = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'input',
...
var _user$project$Main$onPaste = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'paste',
...
var _user$project$Main$shiftKey = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'shiftKey',
	...
	_elm_lang$core$Json_Decode$bool);
var _user$project$Main$decodedKey = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'key',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Main$onKeyUp = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'keyup',
		eventOptions,
		A2(_elm_lang$core$Json_Decode$map, handler, _user$project$Main$decodedKey));
};
var _user$project$Main$onKeyDown = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'keydown',
		eventOptions,
		A3(_elm_lang$core$Json_Decode$map2, handler, _user$project$Main$decodedKey, _user$project$Main$shiftKey));
};
var _user$project$Main$compositionData = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Main$onCompositionEnd = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'compositionend',
		eventOptions,
		A2(_elm_lang$core$Json_Decode$map, handler, _user$project$Main$compositionData));
};
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, isFocused: b, content: c, lastKey: d, caretColumn: e, caretRow: f, isSelected: g, rangeFrom: h};
	});
...
var _user$project$Main$KeyDown = F2(
	function (a, b) {
		return {ctor: 'KeyDown', _0: a, _1: b};
	});
var _user$project$Main$SetText = function (a) {
	return {ctor: 'SetText', _0: a};
};
var _user$project$Main$Backspace = {ctor: 'Backspace'};
var _user$project$Main$Insert = function (a) {
	return {ctor: 'Insert', _0: a};
};
var _user$project$Main$Blured = {ctor: 'Blured'};
var _user$project$Main$Focused = {ctor: 'Focused'};
		...
		while (true) {
			...
			switch (_p0.ctor) {
					...
					return A2(
						...
						model,
						{
							...
							_0: A2(
								...
								_elm_lang$dom$Dom$focus(_p0._0)),
							_1: {ctor: '[]'}
						});
				case 'FocusResult':
					var _p1 = _p0._0;
				...
				case 'Insert':
					var _p2 = _p0._0;
					if (model.isSelected) {
						var rangeRight = A2(_elm_lang$core$Basics$max, model.rangeFrom, model.caretColumn);
						var rangeLeft = A2(_elm_lang$core$Basics$min, model.rangeFrom, model.caretColumn);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									content: A4(_user$project$Main$stringReplace, _p2, rangeLeft, rangeRight, model.content),
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									content: A4(_user$project$Main$stringReplace, _p2, model.caretColumn, model.caretColumn, model.content),
									caretColumn: model.caretColumn + _user$project$Main$charsLength(_p2)
								}),
							{ctor: '[]'});
					}
				case 'Backspace':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								content: A4(_user$project$Main$stringReplace, '', model.caretColumn - 1, model.caretColumn, model.content),
								caretColumn: _user$project$Main$moveCaretLeft(model.caretColumn)
							}),
						{ctor: '[]'});
				case 'SetText':
					var _p3 = _p0._0;
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								content: _elm_lang$core$String$concat(
									{
										ctor: '::',
										_0: model.content,
										_1: {
								...
								caretColumn: model.caretColumn + (_elm_lang$core$String$length(_p3) - _elm_lang$core$String$length(model.content))
							}),
						{ctor: '[]'});
				case 'MoveLeft':
					var caretColumn = _user$project$Main$moveCaretLeft(model.caretColumn);
					var rangeLength = _elm_lang$core$Basics$abs(caretColumn - model.rangeFrom);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								isSelected: model.isSelected && (_elm_lang$core$Native_Utils.cmp(rangeLength, 0) > 0)
							}),
						{ctor: '[]'});
				case 'MoveRight':
					var caretColumn = A2(
						_user$project$Main$moveCaretRight,
						model.caretColumn,
						_user$project$Main$charsLength(model.content));
					var rangeLength = _elm_lang$core$Basics$abs(caretColumn - model.rangeFrom);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
				...
				case 'KeyDown':
					...
					switch (_p4) {
						case 'Backspace':
							if (model.isSelected) {
								var _v3 = _user$project$Main$Insert(''),
								...
								var _v5 = _user$project$Main$Backspace,
						...
						case 'NonConvert':
							return A2(
								...
								{ctor: '[]'});
						case 'ArrowLeft':
							var rangeLength = _elm_lang$core$Basics$abs(model.rangeFrom - model.caretColumn);
							if (_p6) {
								if (model.isSelected) {
									var _v7 = _user$project$Main$MoveLeft,
										_v8 = model;
									msg = _v7;
									model = _v8;
									continue update;
								} else {
									var _v9 = _user$project$Main$MoveLeft,
										_v10 = _elm_lang$core$Native_Utils.update(
										model,
										{isSelected: true, rangeFrom: model.caretColumn});
									msg = _v9;
									model = _v10;
									continue update;
								}
								...
								if (model.isSelected) {
									var _v11 = _user$project$Main$MoveLeft,
										_v12 = _elm_lang$core$Native_Utils.update(
										model,
										{
											isSelected: false,
											caretColumn: A2(_elm_lang$core$Basics$min, model.rangeFrom, model.caretColumn) + 1
										});
									msg = _v11;
									model = _v12;
									continue update;
								} else {
									var _v13 = _user$project$Main$MoveLeft,
										_v14 = model;
									msg = _v13;
									model = _v14;
									continue update;
						...
						case 'ArrowRight':
							...
							if (_p6) {
								if (model.isSelected) {
									var _v15 = _user$project$Main$MoveRight,
										_v16 = model;
									msg = _v15;
									model = _v16;
									continue update;
								} else {
									var _v17 = _user$project$Main$MoveRight,
								...
								if (model.isSelected) {
									var _v19 = _user$project$Main$MoveRight,
										_v20 = _elm_lang$core$Native_Utils.update(
										model,
										{
											isSelected: false,
											caretColumn: A2(_elm_lang$core$Basics$max, model.rangeFrom, model.caretColumn) - 1
										});
									msg = _v19;
									model = _v20;
									continue update;
								} else {
									var _v21 = _user$project$Main$MoveRight,
										_v22 = model;
									msg = _v21;
									model = _v22;
									continue update;
						...
						default:
							if (_elm_lang$core$Native_Utils.eq(
								...
								1)) {
								var _v23 = _user$project$Main$Insert(_p5),
									_v24 = model;
								msg = _v23;
								model = _v24;
								continue update;
...
var _user$project$Main$view = function (model) {
	var rangeLength = _elm_lang$core$Basics$abs(model.rangeFrom - model.caretColumn);
	var rangeLeft = A2(_elm_lang$core$Basics$min, model.rangeFrom, model.caretColumn);
	var codePoints = _elm_community$string_extra$String_Extra$toCodePoints(model.content);
	var caretText = _elm_community$string_extra$String_Extra$fromCodePoints(
		A2(_elm_lang$core$List$take, model.caretColumn, codePoints));
	var rangeLeftText = _elm_community$string_extra$String_Extra$fromCodePoints(
		A2(_elm_lang$core$List$take, rangeLeft, codePoints));
	var rangeInnerText = _elm_community$string_extra$String_Extra$fromCodePoints(
		A2(
			_elm_lang$core$List$take,
			rangeLength,
			A2(_elm_lang$core$List$drop, rangeLeft, codePoints)));
	var caretDisplay = model.isFocused ? _rtfeldman$elm_css$Css$visibility(_rtfeldman$elm_css$Css$visible) : _rtfeldman$elm_css$Css$visibility(_rtfeldman$elm_css$Css$hidden);
	var rangeDisplay = model.isSelected ? _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$block) : _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$none);
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$onPaste(_user$project$Main$Insert),
					_1: {
						ctor: '::',
						_0: _user$project$Main$onKeyDown(_user$project$Main$KeyDown),
						_1: {
							ctor: '::',
							_0: _user$project$Main$onCompositionEnd(_user$project$Main$Insert),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onFocus(_user$project$Main$Focused),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Events$onBlur(_user$project$Main$Blured),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$defaultValue(''),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(''),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(model.id),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
														{
					...
					_rtfeldman$elm_css$Html_Styled$div,
					{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$text_),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
								_user$project$Main$FocusOn(model.id)),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text(rangeLeftText),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text(rangeInnerText),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text(caretText),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
												...
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
													{
														...
														_1: {
															ctor: '::',
															_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'blink .5s alternate infinite ease-in'),
															_1: {ctor: '[]'}
														}
													}),
												_1: {ctor: '[]'}
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text(model.content),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text(
								_elm_lang$core$Basics$toString(model.caretColumn)),
							_1: {ctor: '[]'}
						}
					}
				}
